...
This project implements two complementary approaches to predict liquid volume measurements from images of measuring cups filled with **two different colored liquids** (orange juice and red juice), demonstrating cross-domain transfer learning:
...
- Cross-domain (OR→RED): **82% error reduction** after fine-tuning (214.59 mL → 38.73 mL)
- Demonstrates strong transfer learning and domain adaptation capability
...
## 📓 Key Notebooks - Cross-Domain Transfer Learning

This project includes comprehensive training notebooks demonstrating cross-domain transfer learning across orange juice (OR) and red juice (RED) datasets:

### Orange Juice (OR) Dataset Training

| Notebook | Model | Description | Size |
|----------|-------|-------------|------|
| **Final/OR_Efficientnet_ES.ipynb** | EfficientNet | Main ES(1+1) optimization on OR dataset | 8.1 MB |
| **Final/OR_EfficientNet_ES1.ipynb** | EfficientNet | Optimized version with best hyperparameters | 357 KB |
| **Final/OR_Resnet50_ES.ipynb** | ResNet50 | Alternative architecture for comparison | 1.2 MB |
| **Final/OR_ES_Random_Opt.ipynb** | Custom CNN | Random optimization baseline | 137 KB |

### Red Juice (RED) Dataset Training

| Notebook | Model | Description | Size |
|----------|-------|-------------|------|
| **Final/Red_Efficientnet_ES.ipynb** | EfficientNet | Main ES(1+1) optimization on RED dataset | 8.1 MB |
| **Final/Red_EfficientNet_ES1.ipynb** | EfficientNet | Optimized version with best hyperparameters | 1.2 MB |
| **Final/Red_Resnet50_ES.ipynb** | ResNet50 | Alternative architecture for comparison | 8.2 MB |
| **Final/Red_ES_Random_Opt.ipynb** | Custom CNN | Random optimization baseline | 153 KB |

### Cross-Domain Transfer & Weight Optimization

| Notebook | Description | Key Feature |
|----------|-------------|-------------|
| **FS_Weight_Optimization_OR_Red.ipynb** | Few-shot weight optimization for OR→RED transfer | Demonstrates 82% error reduction |

### Additional Development Notebooks

Located in `code/` directory for experimentation and development:
- `BMC_EfficientNet_Merged.ipynb` - Complete EfficientNet pipeline
- `OR_Base_ES.ipynb`, `OR_Es1plus1.ipynb`, `OR_efficientnet.ipynb` - OR variants
- `Red_baseline.ipynb`, `red_es.ipynb` - RED variants
- `bmc_ES_1plus1_optimization.ipynb` - Full ES optimization (7.8 MB)

### Research Documentation

- **collab_2_siriv2.pdf** - Comprehensive project thesis/report
- **IEEE_Paper_ES_FewShot_Transfer.tex/.md** - Research paper on ES few-shot transfer learning
- **Dataset_Comparison_Report.xlsx** (in code/) - Quantitative comparison of OR vs RED results

### How to Use These Notebooks

1. **Start with**: `Final/OR_Efficientnet_ES.ipynb` or `Final/Red_Efficientnet_ES.ipynb` for main results
2. **For cross-domain learning**: Use `FS_Weight_Optimization_OR_Red.ipynb` to see transfer learning in action
3. **For architecture comparison**: Compare EfficientNet vs ResNet50 notebooks
4. **For optimization research**: Review ES(1+1) vs Random optimization baselines

All notebooks are self-contained with detailed markdown explanations and can be run in Google Colab or Jupyter Lab.
